...
Todo list usando electron e react JS
...
```
https://github.com/felipefariasdasilva/todo-list-electron.git
```
...
## Desenvolvido com
* [Electron](https://www.electronjs.org/) - Framework para construção de Desktop App
